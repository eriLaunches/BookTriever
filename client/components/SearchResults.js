    ...
    <div>
      {
        books.map(book =>
          <div key={book.key}>
            ...
            <img src={`http://covers.openlibrary.org/b/id/${book.cover_i}-S.jpg`} alt='book cover' />
            <Link to={{pathname:'/singleview',  state:{book}}}><p><strong>{book.title_suggest}</strong></p></Link>
